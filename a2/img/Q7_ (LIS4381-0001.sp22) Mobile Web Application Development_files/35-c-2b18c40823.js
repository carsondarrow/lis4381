...
const s=e=>!!(null!==e&&void 0!==e&&e.getAttribute(a))
function l(e,t){d(e,t)
u(e)}function d(e,t){e.ui.registry.addButton(i,{onAction:t,text:Object(o["a"])("Edit"),tooltip:Object(o["a"])("Edit Existing Button / Icon")})}function u(e){e.ui.registry.addContextToolbar(r,{items:i,position:"node",scope:"node",predicate:s})}},"1pz7":function(e,t,n){"use strict"
...
const Et=["trayProps"]
var At,St,jt,It
const Tt=s.a.lazy(()=>n.e(4101).then(n.bind(null,"L5Z7")))
const Lt=s.a.lazy(()=>Promise.all([n.e(3633),n.e(4068)]).then(n.bind(null,"GuXJ")))
const Bt=250
const Dt="400px"
...
this.a11yCheckerReady=Promise.all([n.e(10),n.e(21),n.e(22),n.e(26),n.e(27),n.e(4059)]).then(n.bind(null,"sOmF")).then(e=>{e.default(this.language)
...
this.ltiToolFavorites.length>0&&n.e(3653).then(n.bind(null,"DiQt"))
...
n.d(t,"a",(function(){return Jn}))
n.d(t,"b",(function(){return Xn}))
var o=n("ODXe")
var i=n("VTBJ")
var r=n("Ff2n")
var a=n("q1tI")
...
var _e=n("kyQv")
var me=n("qScw")
const pe="COMPLETE_FILE_UPLOAD"
const fe="FAIL_FILE_UPLOAD"
const he="FAIL_FOLDERS_LOAD"
const ye="FAIL_MEDIA_UPLOAD"
const be="MEDIA_UPLOAD_SUCCESS"
const ge="PROCESSED_FOLDER_BATCH"
const ve="QUOTA_EXCEEDED_UPLOAD"
const we="RECEIVE_FOLDER"
const ke="START_FILE_UPLOAD"
const Ce="START_LOADING"
const Oe="START_MEDIA_UPLOADING"
const Ee="STOP_LOADING"
const Ae="STOP_MEDIA_UPLOADING"
const Se="TOGGLE_UPLOAD_FORM"
function je(){return{type:Ce}}function Ie(){return{type:Ee}}function Te({id:e,name:t,parentId:n}){return{type:we,id:e,name:t,parentId:n}}function Le(e){return{type:he,error:e}}function Be(e){l["a"].showError(e)
return{type:ye,error:e}}function De(){return{type:be}}function Re(e){return{type:ke,file:e}}function Fe(e){return{type:fe,error:e}}function Me(e){return{type:ve,error:e}}function ze(e){return{type:pe,results:e}}function Pe(){return{type:Se}}function Ne({folders:e}){return{type:ge,folders:e}}function Ue(e){return{type:Oe,payload:e}}function $e(){return{type:Ae}}function He(e){return t=>{t(Ue(e))
l["a"].insertImagePlaceholder(e)}}function We(e){return t=>{t($e())
l["a"].removePlaceholders(e)}}function qe(e,t,n){const o=[]
o.push(ze(e))
...
return o}function Ve(e,t){const n=Object(ue["a"])(e)
...
return e}function Ge(e){return(t,n)=>{t(je())
const o=n(),i=o.source,r=o.jwt,a=o.upload,c=o.host,s=o.contextId,l=o.contextType
if(e||a.folders&&0===Object.keys(a.folders).length)return i.fetchFolders({jwt:r,host:c,contextId:s,contextType:l},e).then(({folders:e,bookmark:o})=>{t(e.map(Te))
const i=n(),r=i.upload
t(Ne(r))
t(o?Ge(o):Ie())}).catch(e=>{t(Le(e))})}}function Ke(e,t){const n=t||{},o=n.mediaObject,i=n.uploadedFile
return t=>{if(e){t(Be(e))
t(We(null===i||void 0===i?void 0:i.name))}else{const e={embedded_iframe_url:o.embedded_iframe_url,media_id:o.media_object.media_id,type:i.type,title:i.title||i.name}
t(We(i.name))
Ve(e,"media")
t(De())}}}function Ze(){return(e,t)=>{const n=t(),o=n.source
if(!l["a"].mediaServerSession)return o.mediaServerSession().then(e=>{l["a"].setMediaServerSession(e)})}}function Ye(e,t={}){return(n,o)=>{const i=o(),r=i.source,a=i.jwt,c=i.host,s=i.contextId,l=i.contextType
...
return r.preflightUpload(x,{host:c,contextId:s,contextType:l,onDuplicate:d,category:S["b"]}).then(e=>r.uploadFRD(u,e))})}}function Je(e,t){return(n,o)=>{var r
...
if("media"===e&&t.domObject)return Object(H["a"])(t.domObject,{contextId:_,contextType:m,origin:Object(W["c"])(x),headers:Object(W["b"])(u)},(e,t)=>{n(Ke(e,t))})
...
n(it(e,Object(i["a"])(Object(i["a"])({},t),{},{bookmark:c})))}).catch(e=>{n(We(t.name))
console.error("Fetching the media folder failed.",e)})}}function Xe(e,t,n){const o=t.usageRights
o&&e.setUsageRights(n.id,o)
return n}function Qe(e,t){if(t.href||t.url)return Promise.resolve(t)
return e.getFile(t.id).then(e=>{t.url=e.url
return t})}function et(e,t=new FileReader){return new Promise((n,o)=>{t.onerror=()=>{t.abort()
o(new DOMException("Unable to parse file"))}
t.onload=()=>{n(t.result)}
t.readAsDataURL(e)})}function tt(e,t,n){return/^image\//.test(e["content-type"])?et(t,n).then(t=>{e.thumbnail_url=t
return e}):Promise.resolve(e)}function nt(e,t){e&&(t.alt_text=e)
return t}function ot(e,t){if(e&&e.response)return e.response.json().then(n=>{"file size exceeds quota"===n.message?t(Me(e)):t(Fe(e))}).catch(e=>t(Fe(e)))
if(e)return Promise.resolve().then(()=>t(Fe(e)))}function it(e,t){return(n,o)=>{const r=o(),a=r.source,c=r.jwt,s=r.host,d=r.contextId,u=r.contextType
const x=t.fileReader
n(Re(t))
return a.preflightUpload(t,{jwt:c,host:s,contextId:d,contextType:u}).then(e=>a.uploadFRD(t.domObject,e)).then(e=>Xe(a,t,e)).then(e=>Qe(a,e)).then(e=>Object(me["b"])(u,d,e)).then(e=>tt(e,t.domObject,x)).then(e=>nt(t.altText,e)).then(e=>{t.isDecorativeImage&&(e.isDecorativeImage=t.isDecorativeImage)
t.displayAs&&(e.displayAs=t.displayAs)
return e}).then(e=>{n(We(t.name))
return e}).then(n=>{let o
const r=l["a"].activeEditor()
if(t.bookmark){o=r.editor.selection.getBookmark(2,true)
r.editor.selection.moveToBookmark(t.bookmark)}const a=Ve(Object(i["a"])({contextType:u,contextId:d},n),e)
t.bookmark&&r.editor.selection.moveToBookmark(o)
return a}).then(e=>{n(qe(e,t,u))}).catch(e=>{n(We(t.name))
ot(e,n)})}}const rt="START_FLICKR_SEARCH"
const at="RECEIVE_FLICKR_RESULTS"
const ct="FAIL_FLICKR_SEARCH"
const st="TOGGLE_FLICKR_FORM"
function lt(e){return{type:rt,term:e}}function dt(e){return{type:at,results:e}}function ut(e){return{type:ct,error:e}}function xt(){return{type:st}}function _t(e){return(t,n)=>{const o=n(),i=o.source,r=o.host,a=o.flickr
if(a&&!a.searching){t(lt(e))
return i.searchFlickr(e,{host:r}).then(e=>t(dt(e))).catch(e=>t(ut(e)))}}}const mt="TOGGLE_NEWPAGE_FORM"
function pt(){return{type:mt}}const ft="REQUEST_INITIAL_DOCS"
const ht="REQUEST_NEXT_DOCS"
const yt="RECEIVE_DOCS"
const bt="FAIL_DOCS"
function gt(e){return{type:ft,payload:{contextType:e}}}function vt(e){return{type:ht,payload:{contextType:e}}}function wt({response:e,contextType:t,contextId:n}){const o=e.files,i=e.bookmark
return{type:yt,payload:{files:o,bookmark:i,contextType:t,contextId:n}}}function kt({error:e,contextType:t}){return{type:bt,payload:{error:e,contextType:t}}}function Ct(){return(e,t)=>{const n=t()
return n.source.fetchDocs(n).then(t=>e(wt({response:t,contextType:n.contextType,contextId:n.contextId}))).catch(t=>e(kt({error:t,contextType:n.contextType})))}}function Ot(){return(e,t)=>{const n=t()
const o=n.documents[n.contextType]
if(!(null!==o&&void 0!==o&&o.isLoading)&&null!==o&&void 0!==o&&o.hasMore){e(vt(n.contextType))
return e(Ct())}}}function Et(){return(e,t)=>{const n=t()
e(gt(n.contextType))
return e(Ct())}}var At=n("eAGa")
var St=n("NFDp")
const jt="REQUEST_INITIAL_MEDIA"
const It="REQUEST_MEDIA"
const Tt="RECEIVE_MEDIA"
const Lt="FAIL_MEDIA"
function Bt(e){return{type:jt,payload:{contextType:e}}}function Dt(e){return{type:It,payload:{contextType:e}}}function Rt({response:e,contextType:t}){const n=e.files,o=e.bookmark
return{type:Tt,payload:{files:n,bookmark:o,contextType:t}}}function Ft({error:e,contextType:t}){return{type:Lt,payload:{error:e,contextType:t}}}function Mt(){return(e,t)=>{const n=t()
e(Dt(n.contextType))
return n.source.fetchMedia(n).then(t=>e(Rt({response:t,contextType:n.contextType}))).catch(t=>e(Ft({error:t,contextType:n.contextType})))}}function zt(){return(e,t)=>{const n=t()
const o=n.media[n.contextType]
if(!(null!==o&&void 0!==o&&o.isLoading)&&null!==o&&void 0!==o&&o.hasMore){e(Dt(n.contextType))
return e(Mt())}}}function Pt(){return(e,t)=>{const n=t()
e(Bt(n.contextType))
return e(Mt())}}function Nt({media_object_id:e,title:t,subtitles:n}){return(o,i)=>{const r=i()
const a=r.source.updateMediaObject(r,{media_object_id:e,title:t}).catch(e=>{At["a"].handleAlert({text:Object(St["a"])("Though your video will have the correct title in the browser, we failed to update it in the database."),variant:"error"})
throw e})
const c=r.source.updateClosedCaptions(r,{media_object_id:e,subtitles:n})
return Promise.all([a,c])}}const Ut="CHANGE_CONTEXT"
const $t="CHANGE_CONTEXT_TYPE"
const Ht="CHANGE_CONTEXT_ID"
const Wt="CHANGE_SEARCH_STRING"
const qt="CHANGE_SORT_BY"
function Vt({contextType:e,contextId:t}){return n=>{n(Gt(e))
n(Kt(t))
n({type:Ut,payload:{contextType:e,contextId:t}})}}function Gt(e){return{type:$t,payload:e}}function Kt(e){return{type:Ht,payload:e}}function Zt(e){return{type:Wt,payload:e}}function Yt(e){return{type:qt,payload:e}}const Jt="ALL_FILES_LOADING"
function Xt(e){return{type:Jt,payload:e}}const Qt="action.session.receive_session"
function en(e){return{type:Qt,data:e}}function tn(e,t){var n
const o=t(),i=o.source
return null===(n=i.getSession)||void 0===n?void 0:n.call(i).then(t=>e(en(t)))}function nn(e){return{loadSession:()=>e(tn),onChangeTab:t=>e(p(t)),onChangeAccordion:t=>e(f(t)),fetchInitialPage:t=>e(A(t)),fetchNextPage:t=>e(E(t)),toggleFolder:t=>e(de(t)),fetchFolders:()=>e(Ge()),fetchInitialImages:(t={})=>e($(t)),fetchNextImages:(t={})=>e(U(t)),startUpload:(t,n)=>e(it(t,n)),flickrSearch:t=>e(_t(t)),toggleFlickrForm:()=>e(xt()),toggleUploadForm:()=>e(Pe()),toggleNewPageForm:()=>e(pt()),startButtonsAndIconsUpload:(t,n)=>e(Ye(t,n)),startMediaUpload:(t,n)=>e(Je(t,n)),createMediaServerSession:()=>e(Ze()),mediaUploadComplete:(t,n)=>e(Ke(t,n)),fetchInitialDocs:()=>e(Et()),fetchNextDocs:()=>e(Ot()),fetchInitialMedia:()=>e(Pt()),fetchNextMedia:()=>e(zt()),updateMediaObject:t=>e(Nt(t)),onChangeContext:t=>e(Vt(t)),onChangeSearchString:t=>e(Zt(t)),onChangeSortBy:t=>e(Yt(t)),onAllFilesLoading:t=>e(Xt(t))}}function on(e){const t=e.ui,n=e.containingContext,o=e.contextType,r=e.contextId,a=e.files,c=e.images,s=e.documents,l=e.media,d=e.folders,u=e.rootFolderId,x=e.flickr,_=e.upload,m=e.session,p=e.newPageLinkExpanded,f=e.all_files,h=e.jwt,y=e.host,b=e.source
const g={}
for(const t in e.collections){const n=e.collections[t]
g[t]=n}return Object(i["a"])(Object(i["a"])({containingContext:n,contextType:o,contextId:r,collections:g,files:a,images:c,documents:s,media:l,folders:d,rootFolderId:u,flickr:x,upload:_,session:m,newPageLinkExpanded:p},t),{},{all_files:f,jwt:h,host:y,source:b})}var rn=n("ANjH")
var an=function(e=""){return e}
function cn(e=false,t){switch(t.type){case _:return true
case x:case m:return false
default:return e}}function sn(e=0,t){switch(t.type){case x:return 0
case d:return t.index
default:return e}}function ln(e="",t){switch(t.type){case x:case d:return""
case u:return t.index
default:return e}}var dn=Object(rn["combineReducers"])({hidden:cn,selectedTabIndex:sn,selectedAccordionIndex:ln})
var un=function(e={},t){switch(t.type){case h:return Object(i["a"])(Object(i["a"])({},e),{},{links:[],bookmark:null,isLoading:true,hasMore:true,searchString:t.searchString})
...
function xn(e){return function(t={},n){switch(n.type){case h:case y:case b:case g:return n.key===e?un(t,n):t
default:return t}}}var _n=Object(rn["combineReducers"])({announcements:xn("announcements"),assignments:xn("assignments"),discussions:xn("discussions"),modules:xn("modules"),quizzes:xn("quizzes"),wikiPages:xn("wikiPages")})
function mn(e={},t){switch(t.type){case q:return Object(i["a"])(Object(i["a"])({},e),{},{[t.id]:{id:t.id,name:t.name,type:t.fileType,url:t.url,embed:t.embed}})
default:return e}}const pn={id:null,name:null,loadingCount:0,loading:false,requested:false,expanded:false,filesUrl:null,foldersUrl:null,parentId:null,fileIds:[],folderIds:[]}
function fn(e=pn,t){let n
...
default:return e}}function hn(e={},t){switch(t.type){case V:case G:case K:case Z:case Y:case J:case X:return Object(i["a"])(Object(i["a"])({},e),{},{[t.id]:fn(e[t.id],t)})
default:return e}}function yn(e=null,t){switch(t.type){case Q:return t.id
...
return o
case Ut:return o
case Wt:o.searchString=t.payload
return o
default:return e}}function gn(e={},t){const n=t.payload&&t.payload.contextType
const o=Object(i["a"])({},e)
n&&!o[n]&&(o[n]={files:[],bookmark:null,isLoading:false,hasMore:true})
switch(t.type){case ft:o[n]={files:[],bookmark:null,isLoading:true,hasMore:true}
return o
case ht:o[n].isLoading=true
return o
...
t.payload.files&&0===t.payload.files.length&&(o[n].bookmark=null)
return o
case Ut:case Wt:return o
default:return e}}function vn(e={},t){const n=t.payload&&t.payload.contextType
const o=Object(i["a"])({},e)
n&&!o[n]&&(o[n]={files:[],bookmark:null,isLoading:false,hasMore:true})
switch(t.type){case jt:o[n]={files:[],bookmark:null,isLoading:true,hasMore:true}
return o
case It:o[n].isLoading=true
return o
case Tt:o[n]={files:o[n].files.concat(t.payload.files),bookmark:t.payload.bookmark,isLoading:false,hasMore:!!t.payload.bookmark}
return o
case Lt:o[n]={isLoading:false,error:t.payload.error}
t.payload.files&&0===t.payload.files.length&&(o[n].bookmark=null)
return o
case Ut:case Wt:return o
default:return e}}function wn(e=false,t){switch(t.type){case ke:return true
case fe:case pe:case ve:return false
default:return e}}function kn(e={},t){switch(t.type){case pe:return{}
case ve:return Object(i["a"])(Object(i["a"])({},e),{},{type:t.type})
default:return e}}function Cn(e=false,t){switch(t.type){case pe:return false
case Se:return!e
default:return e}}function On(e={},t){switch(t.type){case we:return Object(i["a"])(Object(i["a"])({},e),{},{[t.id]:{id:t.id,name:t.name,parentId:t.parentId}})
case he:default:return e}}function En(e=null,t){switch(t.type){case we:return null===t.parentId?t.id:e
default:return e}}function An(e={},t){switch(t.type){case ge:{const e=t.folders
const n={}
for(const t in e){const o=e[t]
n[o.id]=n[o.id]||[]
if(o.parentId){n[o.parentId]=n[o.parentId]||[]
n[o.parentId].push(o.id)}}for(const t in n){const o=n[t]
o.sort((t,n)=>e[t].name.localeCompare(e[n].name))}return n}default:return e}}function Sn(e=false,t){switch(t.type){case Ce:return true
case Ee:case he:return false
default:return e}}function jn(e=false,t){switch(t.type){case Ce:return{loading:true,uploaded:false,error:false}
case ye:return{loading:false,uploaded:false,error:true}
case be:return{loading:false,uploaded:true,error:false}
default:return e}}var In=Object(rn["combineReducers"])({uploading:wn,formExpanded:Cn,folders:On,rootFolderId:En,folderTree:An,error:kn,loadingFolders:Sn,uploadingMediaStatus:jn})
var Tn=function(e={},t){switch(t.type){case rt:return Object(i["a"])(Object(i["a"])({},e),{},{searching:true,searchTerm:t.term})
case at:return Object(i["a"])(Object(i["a"])({},e),{},{searching:false,searchResults:t.results})
case ct:return Object(i["a"])(Object(i["a"])({},e),{},{searching:false,searchTerm:"",searchResults:[]})
case st:return Object(i["a"])(Object(i["a"])({},e),{},{formExpanded:!e.formExpanded})
default:return e}}
const Ln={}
function Bn(e=Ln,t){switch(t.type){case Qt:return Object(i["a"])(Object(i["a"])({},e),t.data)
default:return e}}var Dn=function(e=false,t){switch(t.type){case mt:return!e
default:return e}}
function Rn(e="",t){if(t.type===$t)return t.payload
return e}function Fn(e="",t){if(t.type===Ht)return t.payload
return e}function Mn(e="",t){if(t.type===Wt)return t.payload
return e}function zn(e={order:"desc",sort:"date_added"},t){if(t.type===qt)return t.payload
return e}function Pn(e={},t){if(t.type===Jt)return Object(i["a"])(Object(i["a"])({},e),{},{isLoading:t.payload})
return e}var Nn=Object(rn["combineReducers"])({ui:dn,source:an,jwt:an,host:an,containingContext:an,contextType:Rn,contextId:Fn,searchString:Mn,sortBy:zn,all_files:Pn,collections:_n,files:mn,folders:hn,rootFolderId:yn,images:bn,documents:gn,media:vn,upload:In,flickr:Tn,session:Bn,newPageLinkExpanded:Dn})
function Un(e){switch(e){case"course":case"courses":return"course"
case"group":case"groups":return"group"
case"user":case"users":return"user"
default:return}}var $n=function(e={}){let t=e,n=t.source,o=t.jwt,r=t.refreshToken,a=t.host,c=t.contextType,s=t.contextId,l=t.collections,d=t.files,u=t.folders,x=t.upload,_=t.images,m=t.documents,p=t.media,f=t.flickr,h=t.newPageLinkExpanded,y=t.searchString,b=t.sortBy,g=t.all_files
c=Un(c)
...
var Hn=n("sINF")
var Wn=n("FkO2")
var qn=function(e,t){const n=Object(rn["createStore"])(Object(Wn["batching"])(Nn),t||$n(e),Object(rn["applyMiddleware"])(Hn["a"],Wn["batch"]))
...
return n}
const Vn=["children"],Gn=["children"]
function Kn(e){let t=e.children,n=Object(r["a"])(e,Vn)
return t(Object(i["a"])({onLinkClick:l["a"].insertLink,onImageEmbed:l["a"].embedImage,onMediaEmbed:l["a"].embedMedia,onFileSelect:l["a"].insertFileLink},n))}const Zn=Object(s["b"])(on,nn)(Kn)
const Yn=Object(a["createContext"])()
function Jn(e){let t=e.children,n=Object(r["a"])(e,Gn)
const i=Object(a["useState"])(()=>qn(n)),l=Object(o["a"])(i,1),d=l[0]
return c.a.createElement(s["a"],{store:d},c.a.createElement(Zn,null,e=>c.a.createElement(Yn.Provider,{value:e},t(e))))}function Xn(){const e=Object(a["useContext"])(Yn)
...
switch(e){case"ar":i=n.e(4145).then(n.bind(null,"venI"))
break
case"ca":i=n.e(4146).then(n.bind(null,"1Y6O"))
break
case"cy":i=n.e(4147).then(n.bind(null,"we+z"))
break
case"da":i=n.e(4149).then(n.bind(null,"PTiq"))
break
case"da-x-k12":i=n.e(4148).then(n.bind(null,"yNIZ"))
break
case"de":i=n.e(4150).then(n.bind(null,"S8cF"))
break
case"el":i=n.e(4151).then(n.bind(null,"FwcW"))
break
case"en":i=n.e(4219).then(n.bind(null,"NQfO"))
break
case"en-AU-x-unimelb":i=n.e(4152).then(n.bind(null,"3W0S"))
break
case"en-GB-x-ukhe":i=n.e(4153).then(n.bind(null,"KQzV"))
break
case"en-AU":i=n.e(4154).then(n.bind(null,"voS+"))
break
case"en-CA":i=n.e(4220).then(n.bind(null,"m+Mn"))
break
case"en-CY":i=n.e(4221).then(n.bind(null,"mgnU"))
break
case"en-GB":i=n.e(4155).then(n.bind(null,"nxzM"))
break
case"es":i=n.e(4156).then(n.bind(null,"2MaM"))
break
case"es-ES":i=n.e(4157).then(n.bind(null,"HM1o"))
break
case"fa-IR":i=n.e(4158).then(n.bind(null,"01hr"))
break
case"fi":i=n.e(4159).then(n.bind(null,"QFVQ"))
break
case"fr":i=n.e(4160).then(n.bind(null,"8o6s"))
break
case"fr-CA":i=n.e(4161).then(n.bind(null,"Bm8W"))
break
case"he":i=n.e(4162).then(n.bind(null,"mYM8"))
break
case"ht":i=n.e(4222).then(n.bind(null,"ZkKP"))
break
case"hu":i=n.e(4163).then(n.bind(null,"sbbs"))
break
case"hy":i=n.e(4164).then(n.bind(null,"WoYt"))
break
case"is":i=n.e(4223).then(n.bind(null,"/C+o"))
break
case"it":i=n.e(4165).then(n.bind(null,"Qvrh"))
break
case"ja":i=n.e(4166).then(n.bind(null,"XZYX"))
break
case"ko":i=n.e(4167).then(n.bind(null,"vrKU"))
break
case"mi":i=n.e(4224).then(n.bind(null,"LP6z"))
break
case"nb":i=n.e(4169).then(n.bind(null,"Uc+e"))
break
case"nb-x-k12":i=n.e(4168).then(n.bind(null,"56N6"))
break
case"nl":i=n.e(4170).then(n.bind(null,"17Or"))
break
case"nn":i=n.e(4171).then(n.bind(null,"HZtm"))
break
case"pl":i=n.e(4172).then(n.bind(null,"JcWQ"))
break
case"pt":i=n.e(4173).then(n.bind(null,"I9Ke"))
break
case"pt-BR":i=n.e(4174).then(n.bind(null,"7P9b"))
break
case"ru":i=n.e(4175).then(n.bind(null,"V5X0"))
break
case"se":i=n.e(4225).then(n.bind(null,"JKpP"))
break
case"sl":i=n.e(4176).then(n.bind(null,"h8aU"))
break
case"sv":i=n.e(4178).then(n.bind(null,"lfo/"))
break
case"sv-x-k12":i=n.e(4177).then(n.bind(null,"4MO5"))
break
case"th":i=n.e(4179).then(n.bind(null,"TDbP"))
break
case"tr":i=n.e(4180).then(n.bind(null,"V0pu"))
break
case"uk-UA":i=n.e(4181).then(n.bind(null,"yL5t"))
break
case"vi":i=n.e(4182).then(n.bind(null,"rGya"))
break
case"zh":i=n.e(4185).then(n.bind(null,"Sx0h"))
break
case"zh-Hans":i=n.e(4183).then(n.bind(null,"32vL"))
break
case"zh-Hant":i=n.e(4184).then(n.bind(null,"Iyx8"))
break
case"zh-HK":i=n.e(4186).then(n.bind(null,"v1QM"))
break
...
t!==w["b"]&&o.push(a.a.createElement(b["a"].Option,{key:"user_files",id:"user_files",value:"user_files",renderBeforeLabel:C["a"]},L("links"===e||"all"===t?"files":"user")))
...
"all"===n.contentSubtype?n.contentType="user_files":n.contentSubtype===w["b"]&&(n.contentType="course_files")
...
switch(t){case w["b"]:return Object(m["a"])("Buttons and Icons")
...
//# sourceMappingURL=35-c-2b18c40823.js.map